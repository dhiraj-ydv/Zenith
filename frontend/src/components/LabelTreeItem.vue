<template>
  <div class="label-tree-node">
    ...
    <div v-if="!collapsed" class="label-children">
      ...
      >
        <svg v-if="note.type === 'lorien'" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
           <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
        </svg>
        <svg v-else-if="note.type === 'xopp'" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
